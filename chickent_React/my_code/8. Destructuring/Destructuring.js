...
// const [user9, user10, user11, user12="updating"]= userName;
// console.log(user12);  //--> updating, nếu không có df thì ra undefined

//2.4 Destructuring với rest parameter
// const [user13,... cacThimConLai]= userName;
// console.log(user13);
// console.log(cacThimConLai); //--> [Hà, Huy]

// const [user14, user15, user16, user17,... cacThimConLai]= userName;
// console.log(user14, user16,user17 );
// console.log(cacThimConLai); //--> [Hà, Huy]
